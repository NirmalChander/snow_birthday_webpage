...
const createStar = position => {
  ...
  star.className = "fas fa-star"; // Use FontAwesome star icon
...
const createBackgroundStar = () => {
    ...
    star.className = "fas fa-star star"; // Use FontAwesome star icon
    
    star.style.left = px(rand(0, window.innerWidth));
    star.style.top = px(rand(0, window.innerHeight));
    star.style.fontSize = selectRandom(config.sizes);
    star.style.color = `rgb(${color})`;
    star.style.textShadow = `0px 0px 1.5rem rgb(${color} / 0.5)`;
  ...
  // Call the function to create background stars
